...
export default function RenderDate({ date }) {
  ...
  return (
    <div
      aria-label="Date"
      className="mt-4 flex flex-col items-center gap-1 rounded-md border border-light-border-primary bg-light-bg-primary px-4 py-2 dark:border-dark-border-primary dark:bg-dark-bg-primary"
    >
